...
/// `VITEA_SESSION_NAME` / `VITEA_WORKTREE_PATH` / `VITEA_OLD_STATE` / `VITEA_NEW_STATE` を
...
public struct StatusChangeHookRunner: Sendable {
    ...
    public func notify(
        ...
        let environment: [String: String] = [
            "VITEA_SESSION_NAME": sessionName,
            "VITEA_WORKTREE_PATH": worktreePath,
            "VITEA_OLD_STATE": oldState?.rawValue ?? "",
            "VITEA_NEW_STATE": newState.rawValue,
        ]
