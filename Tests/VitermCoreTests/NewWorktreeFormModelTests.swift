...
struct NewWorktreeFormModelTests {
    ...
    func pathPreviewUsesDefaultTemplate() {
        ...
        #expect(form.pathPreview == "/Users/testuser/worktrees/viterm/feat-palette")
    }
    ...
    func detectsPathCollision() {
        let form = makeForm(
            ...
            existingWorktreePaths: ["/Users/testuser/worktrees/viterm/feat-palette"]
        )
    ...
    func noPathCollision() {
        let form = makeForm(
            branchName: "feat/palette",
            existingWorktreePaths: ["/Users/testuser/worktrees/viterm/other-branch"]
        )
    ...
    func buildRequestNewBranch() {
        ...
        #expect(request?.worktreePath == "/Users/testuser/worktrees/viterm/feat-palette")
