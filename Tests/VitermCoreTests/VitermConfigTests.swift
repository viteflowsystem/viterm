...
struct VitermConfigTests {
    ...
    func projectScalarOverridesGlobal() {
        ...
        // Fields the project side does not touch fall back to the global config
    ...
    func statusHooksFieldLevelMerge() {
        ...
        // onBusy is overridden by the project; onIdle is untouched by the project so it falls back to global;
        // onWaitingInput is unspecified in both, so it stays nil.
    ...
    func discoveryRootsUsesGlobalOnly() {
        ...
        // Even if the project side has discoveryRoots, the global value is used as-is.
