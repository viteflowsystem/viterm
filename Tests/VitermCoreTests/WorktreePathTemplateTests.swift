...
struct WorktreePathTemplateTests {
    ...
    let repoRoot = "/Users/testuser/dev/viterm"

    func context(branch: String, project: String = "viterm") -> WorktreePathTemplate.Context {
    ...
    func normalizesBranchSlashes() {
        ...
        #expect(result == "/Users/testuser/worktrees/viterm/feat-foo")
    }
    ...
    func normalizesNestedBranchSlashes() {
        ...
        #expect(result == "/Users/testuser/worktrees/viterm/feat-sub-foo")
    }
    ...
    func literalSuffixMixedWithPlaceholder() {
        ...
        let result = template.expand(context: context(branch: "feat/foo"), homeDirectory: home)
        #expect(result == "/Users/testuser/worktrees/viterm/feat-foo_hogehoge")
    }
    ...
    func absolutePathPassesThrough() {
        ...
        let result = template.expand(context: context(branch: "feat/foo"), homeDirectory: home)
        #expect(result == "/tmp/wt/viterm/feat-foo")
    }
    ...
    func relativePathResolvesAgainstRepositoryRoot() {
        ...
        let result = template.expand(context: context(branch: "feat/foo"), homeDirectory: home)
        #expect(result == "/Users/testuser/dev/viterm/../worktrees/feat-foo")
    }
    ...
    func relativePathHandlesTrailingSlashInRoot() {
        ...
        let context = WorktreePathTemplate.Context(
            projectName: "viterm",
            branch: "feat/foo",
            repositoryRoot: "/Users/testuser/dev/viterm/"
        )
        let result = template.expand(context: context, homeDirectory: home)
        #expect(result == "/Users/testuser/dev/viterm/wt/feat-foo")
    }
    ...
    func allPlaceholdersCombined() {
        ...
        let result = template.expand(context: context, homeDirectory: home)
        #expect(result == "/repo/viterm/feat-foo/feat/foo")
    }
